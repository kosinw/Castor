...
namespace Castor.Emulator.CPU
{
    public partial class Z80
    {
        ...
        {
            // AND instructions
            _operations[0xA0] = RAI(() => B, 0);
            _operations[0xA1] = RAI(() => C, 0);
            _operations[0xA2] = RAI(() => D, 0);
            _operations[0xA3] = RAI(() => E, 0);
            _operations[0xA4] = RAI(() => H, 0);
            _operations[0xA5] = RAI(() => L, 0);
            _operations[0xA6] = RAI(() => AddrHL, 0);
            _operations[0xA7] = RAI(() => A, 0);

            // INC instructions
            _operations[0x03] = RII(() => BC++, false, 4);
            _operations[0x13] = RII(() => DE++, false, 4);
            _operations[0x23] = RII(() => HL++, false, 4);
            _operations[0x33] = RII(() => SP++, false, 4);

            _operations[0x04] = RII(() => B++, true, 0);
            _operations[0x14] = RII(() => D++, true, 0);
            _operations[0x24] = RII(() => H++, true, 0);
            _operations[0x34] = RII(() => AddrHL++, true, 0);

            _operations[0x0C] = RII(() => C++, true, 0);
            _operations[0x1C] = RII(() => E++, true, 0);
            _operations[0x2C] = RII(() => L++, true, 0);
            _operations[0x3C] = RII(() => A++, true, 0);
        }
